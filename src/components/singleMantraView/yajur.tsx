        ...
        <Box sx={{ p: 3, display: 'flex', gap: 3 }}>
            <Paper elevation={3} sx={{ p: 3, width: '30%' }}>
                ...
                <Grid container spacing={1}>
                    {Array.from({ length: TOTAL_ADHYAYAS_IN_YAJURVED }, (_, i) => (
                        <Grid item xs={3} key={i}>
                            <Button
                                variant={selectedAdhyaya === i + 1 ? "contained" : "outlined"}
                                fullWidth
                                onClick={() => createValuesForAdhyaya(i + 1, 1)}
                                sx={{
                                    aspectRatio: '1',
                                    minWidth: 'unset',
                                    backgroundColor: undefined, 
                        ...
                        <FormControl fullWidth>
                            ...
                            <Select
                                ...
                                onChange={(e: SelectChangeEvent<number>) => {
                                    ...
                                    const _mantraCount = getMantraCountInYajurvedaByAdhyaya(value) ?? 0;
                                    setMantraCountForSelectedAdhyaya(_mantraCount);
                                }}
                            >
                ...
                <Paper elevation={3} sx={{ p: 3 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="h6">
                            Yajur Ved Adhyaya {selectedAdhyaya} Mantras:
                        </Typography>
                    </Box>
                    <Box sx={{ display: 'flex', flexWrap: 'wrap' }}>
                        {generateNumberBoxes(mantraCountForSelectedAdhyaya || 0)}
                    </Box>
                    <Box>
                        {mantra && (
                            <>
